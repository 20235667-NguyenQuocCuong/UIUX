...
export const translations = {
  vi: {
    ...
    "timer.subtitle": "Tập trung với kỹ thuật Pomodoro",
    "timer.focus": "Tập trung",
    "timer.break": "Nghỉ ngắn",
    "timer.longBreak": "Nghỉ dài",
    "timer.timeToFocus": "Thời gian tập trung",
    "timer.takeBreak": "Nghỉ ngơi nào",
    "timer.takeLongBreak": "Nghỉ dài thôi",
    "timer.todayProgress": "Tiến trình hôm nay",
    "timer.pomodorosCompleted": "Pomodoros hoàn thành",
    ...
    "timer.tip1": "• Tắt thông báo và tập trung 100% trong 25 phút",
    "timer.tip2": "• Nghỉ ngơi đầy đủ trong giờ nghỉ để tái tạo năng lượng",
    "timer.tip3": "• Sau 4 pomodoros, nghỉ dài 15-30 phút",
  ...
  en: {
    ...
    "timer.subtitle": "Focus with Pomodoro technique",
    "timer.focus": "Focus",
    "timer.break": "Break",
    "timer.longBreak": "Long Break",
    "timer.timeToFocus": "Time to focus",
    "timer.takeBreak": "Take a break",
    "timer.takeLongBreak": "Take a long break",
    "timer.todayProgress": "Today's Progress",
    "timer.pomodorosCompleted": "Pomodoros completed",
    ...
    "timer.tip1": "• Turn off notifications and focus 100% for 25 minutes",
    "timer.tip2": "• Rest fully during breaks to recharge your energy",
    "timer.tip3": "• After 4 pomodoros, take a long 15-30 minute break",
  ...
  ja: {
    ...
    // Study Timer
    "timer.title": "学習タイマー",
    "timer.subtitle": "ポモドーロテクニックで集中",
    "timer.focus": "集中",
    "timer.break": "短い休憩",
    "timer.longBreak": "長い休憩",
    "timer.timeToFocus": "集中時間です",
    "timer.takeBreak": "休憩しましょう",
    "timer.takeLongBreak": "長い休憩をとりましょう",
    "timer.todayProgress": "今日の進捗",
    "timer.pomodorosCompleted": "完了したポモドーロ",
    ...
    "timer.tip1": "• 通知をオフにして25分間100%集中しましょう",
    "timer.tip2": "• 休憩中は十分に休んでエネルギーを回復させましょう",
    "timer.tip3": "• 4ポモドーロ後は15-30分の長い休憩を取りましょう",
